\section{Introduction}
  ...
  \subsection{The LHCb Experiment}
    ...
    Surrounding the point of collision is the \textbf{Ve}rtex \textbf{Lo}cator (VELO), this high precision detector uses silicon strips to detect ionising particles as they propogate from a collition and provides the coordinates of the particle in terms of R\footnote{Radial distance from the beam pipe.} and $\phi$\footnote{Asumthal angle.}.
    ...
    \par
    HCAl and ECAL, shown in Figure~\cite{fig:LHCb_Collab}, are hadronic and electric calorimeters respectively. 
    ...
    Electrons and Photons are absorbed by the ECAl and any Tauons would have decayed long before reaching the far muon detectors.
      ...
      Post LS3, LHCb will have to cope is a luminocity of $\mathsc{L} = 2.10^{33} cm^{-2}s^{-1}$, this is significatly greater than the current $\mathsc{L} = 4.10^{32} cm^{-2}s^{-1}$.
      ...
      \begin{easylist}[itemize]
        & Increase the luminosity to $\mathsc{L} = 2.10^{33} cm^{-2}s^{-1}$.
