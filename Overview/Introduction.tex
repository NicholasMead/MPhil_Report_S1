\section{Introduction}
  ...
  \subsection{The LHCb Experiment}
    ...
    Electrons and Photons are absorbed by the ECAl and any Tauons would have decayed long before reaching the far muon detectors.
      ...
      The main new feature of the upgraded VELO is the switch from silicon stips to pixels.
      The upgraded VELO features 12 ASIC chips with 128 x 128 \cite{ref:VELO_tech}.
